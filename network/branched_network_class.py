...
class branched_network(object):
    ...
    def __init__(self):
        ...
        genre_branch =  np.load(os.getcwd()+ '/network/weights/network_weights_genre_branch.npy', allow_pickle=True, encoding='latin1')[()]
        word_branch = np.load(os.getcwd()+ '/network/weights/network_weights_word_branch.npy', allow_pickle=True, encoding='latin1')[()] 
